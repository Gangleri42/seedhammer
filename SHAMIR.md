...
A threshold extension to [BBQr](BBQr.md).
...
`test_data/shamir_vectors.json` lists, per vector: the data (`data_hex`) and
...
and regenerate the vectors with `-run TestVectors -update`.
